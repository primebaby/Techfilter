...
USERNAME = environ.get('USERNAME', 'https://telegram.me/Mladminbot')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://maxine11229:2d0NThJZDM9iSu48@cluster0.9qvbj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "johnwick")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TGFiles')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002858307046'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/wam.jpg')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

#this vars is for when heroku or koyeb acc get banned, then change this vars as your file to link bot name
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002710313786'))
URL = environ.get('URL', 'https://movie-loverz-bot5-ec6ea87d1788.herokuapp.com/')

# verify system vars
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002858307046'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001948532295')
